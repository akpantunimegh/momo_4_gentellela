...
class BanksControllerTest < ActionController::TestCase
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post :create, bank: { account_id: @bank.account_id, account_number: @bank.account_number, code: @bank.code, name: @bank.name }
    end
  ...
  test "should update bank" do
    patch :update, id: @bank, bank: { account_id: @bank.account_id, account_number: @bank.account_number, code: @bank.code, name: @bank.name }
    assert_redirected_to bank_path(assigns(:bank))
  end
