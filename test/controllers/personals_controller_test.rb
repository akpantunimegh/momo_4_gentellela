...
class PersonalsControllerTest < ActionController::TestCase
  ...
  test "should create personal" do
    assert_difference('Personal.count') do
      post :create, personal: { date_of_birth: @personal.date_of_birth, first_name: @personal.first_name, last_name: @personal.last_name, middle_name: @personal.middle_name, photo: @personal.photo, reference: @personal.reference, user: @personal.user }
    end
  ...
  test "should update personal" do
    patch :update, id: @personal, personal: { date_of_birth: @personal.date_of_birth, first_name: @personal.first_name, last_name: @personal.last_name, middle_name: @personal.middle_name, photo: @personal.photo, reference: @personal.reference, user: @personal.user }
    assert_redirected_to personal_path(assigns(:personal))
  end
